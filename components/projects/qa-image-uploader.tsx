  ...
  const handleFileSelect = (selectedFile: File) => {
    if (!ALLOWED_TYPES.includes(selectedFile.type)) {
      toast({
        ...
        description: "Solo se aceptan imágenes: JPG, PNG, GIF, WEBP",
        variant: "destructive",
      })
      return
    }
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Sube una imagen o screenshot para esta tarea QA. Máximo 5MB.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            className="bg-[#4514F9] hover:bg-[#3810C7] gap-2"
          >
            {uploading ? (
              <>
